...
export const environment = {
  ...
  URI_MELI: `http://auth.mercadolibre.com.uy/authorization?response_type=code&client_id=5381382874135569&state=${Math.floor(Math.random() * 100)}&redirect_uri=https://dropshipping-dev.web.app/home/meli-accounts`,
