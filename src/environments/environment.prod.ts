export const environment = {
  ...
  URI_MELI: `http://auth.mercadolibre.com.uy/authorization?response_type=code&client_id=3756313271086728&state=${Math.floor(Math.random() * 100)}&redirect_uri=https://drop-beeseller.web.app/home/meli-accounts`,
